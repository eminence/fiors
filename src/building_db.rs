...
pub fn construct_building_db() -> HashMap<&'static str, StaticBuildingInfo> {
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 10u32,
        building_cost: &[("BSE", 2u32), ("BDE", 2u32), ("BBH", 4u32), ("BTA", 1u32)],
    };
    map.insert("HB1", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 20u32,
        building_cost: &[("ATA", 4u32), ("ASE", 6u32), ("RDE", 8u32), ("RBH", 8u32)],
    };
    map.insert("HBM", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 18u32,
        building_cost: &[("BDE", 3u32), ("TRU", 4u32), ("BSE", 3u32), ("BBH", 3u32)],
    };
    map.insert("CHP", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 40u32,
        building_cost: &[("TRU", 8u32), ("ADE", 10u32), ("ABH", 6u32), ("ASE", 10u32)],
    };
    map.insert("APF", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 40u32,
        building_cost: &[("TRU", 4u32), ("RDE", 6u32), ("RSE", 8u32), ("RBH", 6u32)],
    };
    map.insert("PP4", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 25u32,
        building_cost: &[("BDE", 6u32), ("BSE", 6u32), ("BBH", 6u32)],
    };
    map.insert("REF", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 37u32,
        building_cost: &[("LSE", 2u32), ("TRU", 8u32), ("LDE", 4u32), ("BSE", 2u32)],
    };
    map.insert("CLF", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 25u32,
        building_cost: &[("BDE", 6u32), ("BBH", 6u32), ("TRU", 4u32), ("BSE", 3u32)],
    };
    map.insert("PP2", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 25u32,
        building_cost: &[("LBH", 2u32), ("BBH", 2u32), ("TRU", 4u32), ("LDE", 2u32)],
    };
    map.insert("FS", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 15u32,
        building_cost: &[("TRU", 4u32), ("MHL", 16u32), ("LBH", 4u32), ("BSE", 2u32)],
    };
    map.insert("HYF", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 16u32,
        building_cost: &[("BSE", 2u32), ("LBH", 4u32), ("TRU", 2u32), ("LDE", 2u32)],
    };
    map.insert("PPF", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 12u32,
        building_cost: &[("BSE", 3u32), ("BDE", 3u32), ("BBH", 3u32)],
    };
    map.insert("FP", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 10u32,
        building_cost: &[("BDE", 2u32), ("BTA", 1u32), ("BBH", 3u32), ("BSE", 4u32)],
    };
    map.insert("INC", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 12u32,
        building_cost: &[("BDE", 2u32), ("BSE", 6u32), ("BBH", 4u32)],
    };
    map.insert("BMP", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 120u32,
        building_cost: &[("ATA", 4u32), ("TRU", 2u32), ("ASE", 8u32)],
    };
    map.insert("ORC", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 30u32,
        building_cost: &[("LDE", 8u32), ("LSE", 12u32), ("TRU", 8u32), ("LBH", 6u32)],
    };
    map.insert("TNP", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 25u32,
        building_cost: &[("LSE", 6u32), ("LDE", 12u32), ("TRU", 8u32)],
    };
    map.insert("LAB", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 32u32,
        building_cost: &[("LSE", 4u32), ("TRU", 6u32), ("LDE", 6u32)],
    };
    map.insert("PP3", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 17u32,
        building_cost: &[("BBH", 4u32), ("BSE", 6u32), ("BDE", 4u32)],
    };
    map.insert("SME", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 45u32,
        building_cost: &[("TRU", 6u32), ("ADE", 6u32), ("ABH", 10u32), ("ASE", 6u32)],
    };
    map.insert("AML", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 35u32,
        building_cost: &[("TRU", 6u32), ("RBH", 4u32), ("RSE", 4u32), ("RDE", 6u32)],
    };
    map.insert("MCA", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 27u32,
        building_cost: &[("LSE", 6u32), ("LBH", 4u32), ("TRU", 5u32)],
    };
    map.insert("GF", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 40u32,
        building_cost: &[("BDE", 2u32), ("TRU", 6u32), ("LBH", 6u32), ("LSE", 3u32)],
    };
    map.insert("WPL", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 30u32,
        building_cost: &[("LDE", 4u32), ("LSE", 6u32), ("LBH", 4u32), ("TRU", 4u32)],
    };
    map.insert("EDM", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 35u32,
        building_cost: &[("RDE", 6u32), ("RSE", 2u32), ("TRU", 4u32), ("RBH", 3u32)],
    };
    map.insert("SCA", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 14u32,
        building_cost: &[("LSE", 4u32), ("LDE", 4u32), ("LTA", 8u32), ("LBH", 4u32)],
    };
    map.insert("HB3", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 18u32,
        building_cost: &[("ADE", 6u32), ("ATA", 4u32), ("ASE", 4u32), ("ABH", 6u32)],
    };
    map.insert("HB5", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 19u32,
        building_cost: &[("BBH", 3u32), ("BSE", 4u32), ("BDE", 3u32)],
    };
    map.insert("PP1", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 35u32,
        building_cost: &[("RSE", 6u32), ("RBH", 4u32), ("TRU", 6u32), ("RDE", 4u32)],
    };
    map.insert("ELP", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 15u32,
        building_cost: &[("TRU", 2u32), ("LBH", 8u32), ("BSE", 4u32), ("BDE", 4u32)],
    };
    map.insert("POL", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 25u32,
        building_cost: &[("LDE", 2u32), ("TRU", 5u32), ("LBH", 2u32), ("LSE", 2u32)],
    };
    map.insert("FER", x);
    ...
    let x = StaticBuildingInfo {
        ...
        scientists: 0u32,
        area_cost: 15u32,
        building_cost: &[("BSE", 2u32), ("BDE", 6u32), ("BBH", 6u32)],
    };
    map.insert("STO", x);
